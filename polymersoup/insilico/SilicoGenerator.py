...
def generate_MS1_compositional_dict(
    ...
    MS1_dict = generate_ms1_mass_dictionary_adducts_losses(
        ...
        modifications=ms1_params["modifications"],
        monomer_modifications_dict=ms1_params["side_chain_tags"],
        universal_modification=ms1_params["universal_sidechain_modifications"],
        max_total_modifications=ms1_params["max_total_sidechain_modifications"],
        max_monomer_modifications=ms1_params["max_monomer_sidechain_modifications"],
        universal_ms1_mass_shift=ms1_params["universal_ms1_sidechain_mass_shift"],
